...
use config\MongoClient as MongoClient;
...
class MG implements IMG
{
        ...
        {
                $host = MongoClient::$Mongo['SQLLocalhost'];
                $port = MongoClient::$Mongo['SQLPort'];
                $dbName = MongoClient::$Mongo['SQLDatabaseName'];
                try {
                        self::$manager = new Manager("mongodb://$host:$port");
                        self::$mongoDB = MongoClient::$Mongo['SQLDatabaseName'];
                        //连接成功
